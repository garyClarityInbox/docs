...
**Solution**: After setup, when prospects ask to schedule a demo, ClarityInbox automatically suggests: [_"I'd love to show you how this works! Here's my calendar to book a 30-minute demo: calendly.com/sarah/demo"_](http://calendly.com/sarah/demo)
