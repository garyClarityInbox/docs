...
### _Did you know?_ **VIP customers account for up to 70% of revenue at B2B startups—92% leave after poor support. [XXX]**
...
```c expandable
When email is from VIP account and contains urgency or urgent language ("asap", "immediate", "priority"), reply instantly: "We'll prioritize this right away—here's my calendar [vip-calendar-link]." CC: ceo@startup.com, head.sales@startup.com. File the email under the company’s label [company label], and “Exec Attention”.
```
